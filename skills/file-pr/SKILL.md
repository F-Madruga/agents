...
Before filing, check wether a PR for this branch already exists. Review the diff locally against `origin/main` to make sure it's contents match the goal.
...
Open a real PR rather than a draft unless the user specifies.
