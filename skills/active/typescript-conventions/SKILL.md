...
description: TypeScript conventions to follow. Must always apply when reading or editing any .ts or .tsx file, and in any other work that touches TypeScript.
---
...
Examples: `references/conventions.md`.
